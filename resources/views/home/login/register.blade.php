...
<html lang="zh" data-hairline="true" data-theme="light">
    <head>
         <meta charset="utf-8" />
         <title data-react-helmet="true"> 星空 </title>
         <link href="/css/login.css" rel="stylesheet" />
         <script type="text/javascript" src="/js/login.js"></script> 
         <style type="text/css">
         	.SignFlowHeader-slogen { color: #02a2aa; }
        </style>
    </head>
                        ...
                        <div class="SignFlowHomepage">
                            <div class="SignFlowHomepage-content">
                                <div class="Card SignContainer-content">
                                 ...
                                 <form action="/home/save" method="post" name="form" id="forms">
                                                         ...
                                                         <div class="SignFlowInput SignFlow-accountInputContainer">
                                                          <div class="SignFlow-accountInput Input-wrapper ">
                                                             <input type="text" id="uname"  name="fname" class="Input" placeholder="用户名(1~8个字符必填)" required/> 
                                                         </div>
                                                                 <div id="name"></div>
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="SignFlowInput SignFlow-accountInputContainer">
                                                                <div class="SignFlow-accountInput Input-wrapper">
                                                                    ...
                                                                    <input type="password" id="psword" name="pwd" class="Input" placeholder="密码(必填)" 
                                                                    required/>
                                                                </div>
                                                                 <div id="pword"></div>
                                                            </div>
                                                         ...
                                                         <div class="SignFlow-account">
                                                            <div class="SignFlowInput SignFlow-accountInputContainer">
                                                                <div class="SignFlow-accountInput Input-wrapper">
                                                                    ...
                                                                    <input type="password" id="repsword" name="repwd" class="Input" placeholder="确认密码(必填)"
                                                                   required />
                                                                </div>
                                                                <div id="repword"></div>
                                                            </div>
                                                          ...
                                                          <div class="SignFlow-account">
                                                            <div class="SignFlowInput SignFlow-accountInputContainer">
                                                                <div class="SignFlow-accountInput Input-wrapper">
                                                                    ...
                                                                    <input type="text" id="tel" name="phone" class="Input" placeholder="手机号(必填)"
                                                                    required/>
                                                                </div>
                                                                <div id="tels"></div>
                                                            </div>
                                                         ...
                                                         <div class="SignFlow-account">
                                                            <div class="SignFlowInput SignFlow-accountInputContainer">
                                                                <div class="SignFlow-accountInput Input-wrapper">
                                                                    ...
                                                                    <input type="text" id="email" name="email" class="Input" placeholder="邮箱地址(必填)"
                                                                   required />
                                                                </div>
                                                                <div id="remail"></div>
                                                            </div>
